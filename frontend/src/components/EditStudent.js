...
function EditStudent() {
  ...
  useEffect(() => {
    axios.get(`https://student-management-system-64xs.onrender.com/students/${id}`)
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.put(`https://student-management-system-64xs.onrender.com/students/${id}`, formData)
  .then(() => {
